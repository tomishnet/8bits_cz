...
{    
    ...
    {     
        ...
        if($this->status != 'sent') {
            ...
            $html .= '<input class="submit btn btn-success  input-lg" ';
    ...
    {   
        ...
        switch($type) {
            ...
            case 'captcha' :
                ...
                $html .=    '<br>opište, prosím, text z obrázku';
                $html .= '</div></label></div>
                <a href="#"';
                ...
                break;
            case 'fieldcaptcha' :
                $html .= '<input id="' . $id . '" class="form-control" type="text" name="' . $name . '" />';
                break;
            case 'checkbox' :
            ...
            case 'select' :
                $html .= '
                <select id="' . $id . '" class="form-control" name="' . $name . '"' . $disabled . '>';
                foreach($this->value as $i => $v) {
            ...
            case 'password' :
                ...
                break;
            //case 'file' :
                $html .= '<input id="' . $id . '" class="form-control" ';
