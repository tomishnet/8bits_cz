 ...
 *
 ***********************************************************************************/
function simplecache_user_is_admin(){
  GLOBAL $USR;
...
function simplecache_pagestart() {
  ...
  global $PRETTYURLS;
  //caching enabled?
  if ($simplecache_conf['enabled']=='Y' && simplecache_user_is_admin()==false) {
...
//        $simplecache_file = $simplecache_dir .  md5(curPageURL) . '.cache';
...
function simplecache_manage() {
  ...
  if (is_dir($simplecache_dir)) {
    ...
    echo '<form name="status" class="manyinputs" action="load.php?id=!_simplecache" method="post">';
    ...
    echo '<form name="settings" class="manyinputs" action="load.php?id=!_simplecache" method="post">';
