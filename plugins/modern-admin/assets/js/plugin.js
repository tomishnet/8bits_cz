$(document).ready(function(){
	...
	$('#sidebar').after("<div class='user-tools'><a href='settings.php' class='settings' title='Site Settings'><i class='fa fa-cogs'></i></a><a href='support.php' class='help' title='GetSimple CMS Help'><i class='fa fa-life-ring'></i></a><a href='logout.php' class='power-off' title='Logout'><i class='fa fa-power-off'></i></a><div style='clear: both'></div></div>");
