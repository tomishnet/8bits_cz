...
$folderImgSrc = '../plugins/SpecialPagesExtras/img/folder.png';
$thumbSrc = '../plugins/SpecialPagesExtras/thumb/?mode=extra-browser-thumb&img=';
$pluginId = 'SpecialPagesExtras'; //used for localization 
