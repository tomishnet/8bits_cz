...
$( document ).ready(function() {
	...
	function validateImageSize($row){
		...
		//if there are set required width or height	check
		if (settings['required-width'] || settings['required-height']){
			if (settings['required-width'] !== '' && !validateSize(settings['required-width-comparator'], settings['required-width'], rowData.imgWidth))
				failedSizeValidation = true;
			
			
			if (settings['required-height'] !== '' && !validateSize(settings['required-height-comparator'], settings['required-height'], rowData.imgHeight))
				failedSizeValidation = true;
        ...
        rowData.notValidSize = notValidSize;
	}	
